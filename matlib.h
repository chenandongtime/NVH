...
Mm DLLI colorbar();
Mm DLLI rgbplot(cMm _map);
Mm DLLI colorbar(cMm h);
Mm DLLI colormap();
Mm DLLI colormap(cMm _map);
...
Mm DLLI imread(cMm filename, cMm fmt, i_o_t, Mm& cdata, Mm& _map);
Mm DLLI imread(cMm filename, i_o_t, Mm& cdata, Mm& _map);
...
Mm DLLI bmpread(cMm filename, i_o_t, Mm& cdata, Mm& _map);
Mm DLLI tiffwrite(cMm varargin);
Mm DLLI tiffread(cMm filename);
Mm DLLI tiffread(cMm filename, i_o_t, Mm& cdata, Mm& _map);
Mm DLLI pcxwrite(cMm varargin);
Mm DLLI pcxread(cMm filename);
Mm DLLI pcxread(cMm filename, i_o_t, Mm& cdata, Mm& _map);
Mm DLLI gifwrite(cMm varargin);
Mm DLLI gifread(cMm filename);
Mm DLLI gifread(cMm filename, i_o_t, Mm& cdata, Mm& _map);
Mm DLLI jet();
Mm DLLI jet(cMm m);
Mm DLLI lines();
Mm DLLI lines(cMm m);
